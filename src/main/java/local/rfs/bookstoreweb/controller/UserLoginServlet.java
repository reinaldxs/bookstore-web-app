 ...
 */
package local.rfs.bookstoreweb.controller;
...
import local.rfs.bookstoreweb.model.dao.UserDAO;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user != null) {
                ...
                Logger.getLogger(UserDAO.class.getName()).log(Level.INFO, "Usuario Logado: {0}", user.getFullName());
            } else {
